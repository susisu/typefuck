...
export type Test_Recurse_4 = Assert<
  Equal<Recurse<{ __rec: { __rec: { __rec: { __rec: 42 } } } }>, 42>
>;
...
export type Test_Recurse_9 = Assert<
  Equal<Recurse<{ __rec: { __rec: { __rec: { __rec: never } } } }>, never>
>;
